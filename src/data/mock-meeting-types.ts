...
export const MEETING_TYPE_CARDS: MeetingTypeCardData[] = [
  {
    meetingType: {
      ...
      durationMinutes: 30,
      format: "one-on-one",
      bookingUrl: "https://schedra.app/book/consultation-30",
    },
    icon: Video,
    accent: "neutral",
  },
  {
    meetingType: {
      ...
      durationMinutes: 60,
      format: "one-on-one",
      bookingUrl: "https://schedra.app/book/strategy-call-60",
    },
    icon: Video,
    accent: "peach",
  },
  {
    meetingType: {
      ...
      durationMinutes: 30,
      format: "group",
      bookingUrl: "https://schedra.app/book/quick-demo",
    },
    icon: Monitor,
    accent: "blue",
  },
  {
    meetingType: {
      ...
      durationMinutes: 45,
      format: "one-on-one",
      bookingUrl: "https://schedra.app/book/interview-session",
    },
    icon: Users,
    accent: "pink",
  },
